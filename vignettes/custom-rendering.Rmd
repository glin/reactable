...
cellInfoProps <- dplyr::tribble(
  ...
  "toggleRowSelected", "function (isSelected?: boolean)", tagList("function to toggle the row's selection. Optionally pass ", tags$code("true"), " to select or ", tags$code("false"), " to deselect. (new in v0.4.5.9000)")
)
...
columnProps <- dplyr::tribble(
  ...
  "filterValue", '"petal"', "column filter value",
  "setFilter", 'function (value: any)', tagList("function to set the column filter value",  "(set to ", tags$code("undefined"), " to clear the filter)"),
