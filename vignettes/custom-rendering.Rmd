...
stateProps <- dplyr::tribble(
  ...
  "filters", '[{ id: "Species", value: "petal" }]', "array of column filter values (new in v0.3.0)",
  "searchValue", '"petal"', "table search value (new in v0.3.0)",
  "selected", '[0, 1, 4]', "array of selected row indices (zero-based, new in v0.3.0)",
...
columnProps <- dplyr::tribble(
  ...
  "data", '[{ Petal.Length: 1.7, Petal.Width: 0.2, _subRows: [] }, ...]', "sorted array of row data values in the table (deprecated in v0.3.0)"
)
