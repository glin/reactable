...
This example demonstrates virtual scrolling with 100,000 rows. Virtual scrolling renders only the visible rows on screen, allowing you to scroll through large tables without performance issues. For an alternative using pagination instead of virtual scrolling, see [100k Rows](100k-rows.html).
