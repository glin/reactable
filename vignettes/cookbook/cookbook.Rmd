...
An alternate method would be to use the [tippy package](http://tippy.john-coene.com/),
...
> Side note: the reactable package documentation uses a [system font stack](https://css-tricks.com/snippets/css/system-font-stack):
>
> ```css
