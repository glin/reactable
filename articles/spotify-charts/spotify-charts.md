...
Source: [Spotify
Charts](https://spotifycharts.com/regional/global/weekly/latest),
[Spotify](https://open.spotify.com/playlist/37i9dQZEVXbMDoHDwVN2tF) via
[spotifyr](https://github.com/charlie86/spotifyr)

Raw data: [`top_tracks.json`](top_tracks.json),
[`get-top-tracks.R`](get-top-tracks.R)
